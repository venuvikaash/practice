  ...
  return (
    <div className="menu-component">
      <div className="menu-table">
        ...
        <div className="menu-heading">Order Online</div>
      </div>
      <div className="menu-table">
        <div className="menu-photo">
          <img src={MenuPhoto2} alt="" />
        </div>
        <div className="menu-heading">Dining</div>
      </div>
      <div className="menu-table">
        <div className="menu-photo">
          <img src={MenuPhoto3} alt="" />
        </div>
        <div className="menu-heading">Zomato Pro</div>
      </div>
      <div className="menu-table">
        <div className="menu-photo">
          <img src={MenuPhoto4} alt="" />
        </div>
        <div className="menu-heading">Nightlife and Club</div>
      </div>
    </div>
  );
};
